class Temperatura(object): 
	...
	def imprimir(self):
		print self.getDia(), self.getMxt(), self.getMnt()
...
def main():
	...
	for x in range(30):
		...
		temperatura.setDia(archivo.read(2))
		archivo.seek(2, 1)
		temperatura.setMxt(int(archivo.read(2)))
		archivo.seek(4, 1)
		temperatura.Mnt = int(archivo.read(2))
		arregloTemperatura.agregar(temperatura)
		archivo.seek(78,1)
